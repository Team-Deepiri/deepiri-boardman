...
def format_task_draft_for_prompt(draft: dict[str, Any]) -> str:
    ...
    if not fv and not summary:
        # Nothing saved means nothing to say. The model does not need prompting here;
        # defaults are resolved deterministically. This branch used to spend 600 characters on
